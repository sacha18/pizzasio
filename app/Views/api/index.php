        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="mb-4">
                    ...
                    <div class="alert alert-primary"><b><?= site_url(); ?>Api/{objet}</b></div>
                </div>
            </div>
        </div>
        <!-- Détails des API -->
                ...
                <div class="card-body">
                    <div data-bs-spy="scroll" data-bs-target="#list-api" data-bs-smooth-scroll="true" class="scrollspy-example" tabindex="0">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="alert alert-primary"><b><?= site_url(); ?>Api/<?= $api['endpoint']; ?><?= (isset($api['params'])) ? '{params}' : null; ?> </b></div>
                            ...
                            <div class="alert alert-info"><?= site_url(); ?>Api/<b><?= $api['endpoint']; ?><?= (isset($api['exemple_params'])) ? $api['exemple_params'] : null; ?></b></div>
