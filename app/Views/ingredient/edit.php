            ...
            <div class="card-header">
                ...
                ?>
                    <div class="card-toolbar">
                        ...
                        <a href="/Ingredient/delete?id=<?= $ing['id'] ?>" class="btn btn-sm btn-danger swal2-confirm" 
                        data-bs-toggle="tooltip"
                        data-bs-title="Supprimer l'ingredient"
                        text-swal2="Voulez-vous vraiment supprimé l'ingredient <?php $ing['name']; ?>"
                        >
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    ...
                    <div class="form-check form-switch form-check-custom form-check-solid">
                        <input class="form-check-input" type="checkbox" value="" id="bio" name="bio" <?= (isset($ing) && $ing['bio'] == true)  ? 'checked' : '' ?> />
                    </div>
                </div>
            </div>
                <div class="row mb-3">
                    ...
                    <div class="form-check form-switch form-check-custom form-check-solid">
                        <input class="form-check-input" type="checkbox" value="" id="vegan" name="vegan" <?= (isset($ing) && $ing['vegan'] == true)  ? 'checked' : '' ?> />
                    </div>
                    </div>
                </div>
