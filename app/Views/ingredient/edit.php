<form action="<?= site_url('/Ingredient/save') ?>" method="POST">
    <div class="container">
        <div class="card">
            <div class="card-header">
                ...
                <?php if (isset($ing)) { ?>
                    <div class="card-toolbar">
                        <a href="<?= site_url('/Ingredient/delete?id=' . $ing['id']) ?>" class="btn btn-sm btn-danger swal2-confirm" data-bs-toggle="tooltip" data-bs-title="Supprimer l'ingredient" text-swal2="Voulez-vous vraiment supprimé l'ingredient <?= $ing['name']; ?>">
            ...
            <div class="card-body">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input id="name" type="text" class="form-control" name="name" value="<?= isset($ing) ? $ing['name'] : ''; ?>" required>
                    </div>
                </div>
                <div class="mb-3 row">
                    <label for="stock" class="col-sm-2 col-form-label">Stock</label>
                    <div class="col-sm-10">
                        <input id="stock" type="text" class="form-control" name="stock" value="<?= isset($ing) ? $ing['stock'] : ''; ?>" required>
                    </div>
                </div>
                <div class="mb-3 row">
                    <label for="price" class="col-sm-2 col-form-label">Prix</label>
                    <div class="col-sm-10">
                        <input id="price" type="price" class="form-control" name="price" value="<?= isset($ing) ? $ing['price'] : ''; ?>" required>
                    </div>
                </div>
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <select class="form-select" name="id_category">
                            <?php foreach ($categ as $c) { ?>
                                <option value="<?= $c['id']; ?>" <?= (isset($ing) && $ing['id_category'] == $c['id']) ? 'selected' : ''; ?>>
                                    <?= $c['name']; ?>
                                </option>
                            <?php } ?>
                        </select>
