<form action="<?= site_url('/Step/save') ?>" method="POST">
    <div class="container">
        <div class="card">
            <div class="card-header">
                ...
                ?>
                    <div class="card-toolbar">
                        <a href="<?= site_url('/Step/delete?id=' . $step['id']) ?>" class="btn btn-sm btn-danger swal2-confirm" data-bs-toggle="tooltip" data-bs-title="Supprimer l'étape" text-swal2="Voulez-vous vraiment supprimer l'étape <?= $step['name']; ?>">
