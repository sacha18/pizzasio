    ...
    <div class="container">
        <div class="card">
            <div class="card-header">
                ...
                <?php if (isset($u) && $u['id'] != 1): ?>
                    <div class="card-toolbar">
                        <a href="<?= site_url('Users/delete?id=' . $u['id']) ?>" class="btn btn-sm btn-danger swal2-confirm"
                           data-bs-toggle="tooltip"
                           data-bs-title="Supprimer l'utilisateur"
                           text-swal2="Voulez-vous vraiment supprimer le compte <?= $u['username']; ?>"
                        >
